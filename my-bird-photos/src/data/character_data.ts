...
export const characterData: ICharacterData = {
  'オオワシ': {
    ...
    description: `オオワシは、世界でもっとも大きなワシのなかまのひとつです。<br>
    とても力もちで、空を大きな羽ではばたきながら飛びます。<br>
ロシアで生まれ、日本の北海道に冬にやってきます。<br>
<br>
発見した学者の名前から「ステラーワシ」とも呼ばれます。<br>
数が減っていて絶滅危惧種に指定されています。<br>
<br>
GBは冬の羅臼で一生分見ましたが、<br>
