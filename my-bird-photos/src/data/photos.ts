...
export const photos: IPhoto[] = [
  {
    id: '1',
    src: process.env.PUBLIC_URL + '/images/birds/20250719_ibaraki_owl.JPG',
    thumbnail: process.env.PUBLIC_URL + '/images/birds/20250719_ibaraki_owl.JPG',
    prefecture: '茨城県',
    date: '2025-07-19',
    birdSpecies: 'フクロウ',
    locationDetail: '',
  ...
  {
    id: '3',
    src: process.env.PUBLIC_URL + '/images/birds/20250712_ibaraki_tern.JPG',
    thumbnail: process.env.PUBLIC_URL + '/images/birds/20250712_ibaraki_tern.JPG',
    prefecture: '茨城県',
    date: '2025-07-12',
    birdSpecies: 'アジサシ',
    locationDetail: '',
